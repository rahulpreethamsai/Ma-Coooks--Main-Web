...
export default function Page() {
  return (
    <ServiceAreaPage 
      ...
      localStory="Nestled in the heart of Hyderabad's financial and technology corridor, Gachibowli is home to thousands of busy IT professionals, students, and young families. With hectic work schedules, finding the time to cook nutritious, clean food is a daily struggle. Ruchi Rush connects you with vetted, local home chefs who prepare traditional meals in small batches, ensuring you get wholesome, healthy nutrition without the restaurant grease."
      chefIds={["chef_1"]}
    />
  );
}
